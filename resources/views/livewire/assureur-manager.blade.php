<div class="p-6">
    ...
    <div class="mb-4 flex items-center gap-4">
        <input type="text" wire:model="search" placeholder="Rechercher un assureur..." class="w-full rounded border border-black border-gray-300">
        <button wire:click="openModal" class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">+ Nouvel assureur</button>
    </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($assureurs as $assureur)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                <button wire:click="openModal({{ $assureur->IDAssureur ?? $assureur->ID }})" class="text-indigo-600 hover:text-indigo-900 mr-3">Modifier</button>
                                <button wire:click="confirmDelete({{ $assureur->IDAssureur ?? $assureur->ID }})" class="text-red-600 hover:text-red-900">Supprimer</button>
                            </td>
                        </tr>
                    @empty
                        <tr>
            ...
            <div class="bg-white rounded-lg shadow-lg w-full max-w-lg p-8 relative">
                ...
                <form wire:submit.prevent="save">
                    <div class="mb-4">
                        ...
                        <input type="text" wire:model.defer="libAssurance" id="libAssurance" class="mt-1 block w-full rounded-md border border-black border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" step="0.01" wire:model.defer="tauxdePEC" id="tauxdePEC" class="mt-1 block w-full rounded-md border border-black border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
            <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-8 relative">
                ...
                <div class="flex justify-end space-x-3">
                    <button wire:click="deleteAssureur" class="px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700">Supprimer</button>
